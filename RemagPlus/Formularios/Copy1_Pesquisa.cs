   ...
   public class Pesquisa<T>:frmPesquisa where T:class
    {
       ...
       public Pesquisa(string tabela, string[] campos,int[] tamanho, string[] titulo, string tituloForm, bool isForm)
        {
            this._campos = campos;
            this._tabela = tabela;
            this._titulo=titulo;
       ...
       public Pesquisa(string tabela, string[] campos, int[] tamanho, string[] titulo, string tituloForm, bool isForm, remag_empresa empresa, bool isEmpresa)
           : this(tabela, campos, tamanho, titulo, tituloForm, isForm)
       {
        ...
        public override void ExecutaPesquisa()
        {
            ...
            List<T> lista = Crud<T>.GetPesquisa<T>(_tabela, (string)this.comboBoxFiltro.SelectedValue, valor); ;
            if (_isEmpresa)
            {
                lista=Crud<T>.GetPesquisa<T>(_tabela, (string)this.comboBoxFiltro.SelectedValue, valor, _empresa);
            }
