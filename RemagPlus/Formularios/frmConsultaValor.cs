...
namespace RemagPlus.Formularios
{
    public partial class frmConsultaValor : Form
    {
        ...
        private void DoConsulta()
        {
            ...
            {
                individualizacao = dataContext.GetIndividualizacao(Globals.Empresa);
            }
            else if (radioButtonFuncionario.Checked)
            {
                individualizacao = dataContext.GetIndividualizacao(Globals.Empresa, TextBoxPesquisa.Text);
            }
            else if (radioButtonDataRecolhimento.Checked)
            {
                individualizacao = dataContext.GetIndividualizacao(Globals.Empresa, Convert.ToDateTime(TextBoxPesquisa.Text));
            }
            else if (radioButtonCompetencia.Checked)
            {
                individualizacao = dataContext.GetIndividualizacao(Globals.Empresa, TextBoxPesquisa.Text, true);
            }
